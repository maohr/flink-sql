...
(function() {
    ...
    MT("reference-type-instructions", "[keyword ref.null] [keyword extern]", "[keyword ref.null] [keyword func]", "[keyword ref.is_null] ([keyword ref.func] [variable-2 $f])", "[keyword ref.func] [variable-2 $f]");
