        ...
        function(config, parserConfig) {
            ...
            return {
                startState: function() {
                    ...
                    return { html: html, php: php, curMode: parserConfig.startOpen ? phpMode : htmlMode, curState: parserConfig.startOpen ? php : html, pending: null };
                },
                ...
                copyState: function(state) {
                    ...
                    return { html: htmlNew, php: phpNew, curMode: state.curMode, curState: cur, pending: state.pending };
                },
