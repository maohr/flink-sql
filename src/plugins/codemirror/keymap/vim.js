...
(function(mod) {
    ...
    var Vim = function() {
            ...
            for (var i = 0; i < ranges.length; i++) {
                ...
                if (range.empty()) {
                    ...
                    if (range.anchor.ch < lineLength) {
                        ...
                        result.push(cm.markText(Pos(range.anchor.line, lineLength - 1), Pos(range.anchor.line, lineLength), { className: "cm-fat-cursor-mark" }));
                    }
                }
            }
        ...
        CodeMirror.defineOption("vimMode", false, function(cm, val, prev) {
            ...
            else if (!val && prev != CodeMirror.Init && /^vim/.test(cm.getOption("keyMap"))) cm.setOption("keyMap", "default");
        });
        ...
        var commandDispatcher = {
            ...
            processEx: function(cm, vim, command) {
                ...
                if (command.type == "keyToEx") {
                    ...
                    if (vim.visualMode) {
                        showPrompt(cm, { onClose: onPromptClose, prefix: ":", value: "'<,'>", onKeyDown: onPromptKeyDown, selectValueOnOpen: false });
                    } else {
       ...
       */
        ...
        */
        ...
        function dialog(cm, template, shortText, onClose, options) {
            if (cm.openDialog) {
                cm.openDialog(template, onClose, { bottom: true, value: options.value, onKeyDown: options.onKeyDown, onKeyUp: options.onKeyUp, selectValueOnOpen: false });
            } else {
