...
(function(mod) {
    ...
    function markChanges(editor, diff, type, marks, from, to, classes) {
        ...
        function markChunk(start, end) {
            ...
            if (start == end && bfrom == end && bto == end) {
                if (bfrom) marks.push(addClass(editor, bfrom - 1, classes, false, false, true));
    ...
    function drawConnectorsForChunk(dv, chunk, sTopOrig, sTopEdit, w) {
        ...
        if (dv.copyButtons) {
            ...
            if (editOriginals) {
                ...
                copyReverse.chunk = { editFrom: chunk.origFrom, editTo: chunk.origTo, origFrom: chunk.editFrom, origTo: chunk.editTo };
    ...
    function copyChunk(dv, to, from, chunk) {
        ...
        if (handler) handler(dv.mv, from, origStart, origEnd, to, editStart, editEnd);
    ...
    function getChunks(diff) {
        ...
        for (var i = 0; i < diff.length; ++i) {
            ...
            if (tp == DIFF_EQUAL) {
                ...
                if (cleanToEdit > cleanFromEdit) {
                    if (i) chunks.push({ origFrom: startOrig, origTo: cleanFromOrig, editFrom: startEdit, editTo: cleanFromEdit });
        ...
        if (startEdit <= edit.line || startOrig <= orig.line) chunks.push({ origFrom: startOrig, origTo: orig.line + 1, editFrom: startEdit, editTo: edit.line + 1 });
        return chunks;
    }
