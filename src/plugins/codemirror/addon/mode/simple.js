...
(function(mod) {
    ...
    function enterLocalMode(config, state, spec, token) {
        ...
        state.local = { mode: mode, end: spec.end && toRegex(spec.end), endScan: spec.end && spec.forceEnd !== false && toRegex(spec.end, false), endToken: token && token.join ? token[token.length - 1] : token };
    }
